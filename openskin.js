...
function OpenSkin() {
  ...
  this.load = function() {
    ...
    element += "#emulatorPopup {" + sanLite(OpenSkin_jsonContents.styles[0].emulatorPopup) + ";" + "}";
    ...
    if(OpenSkin_jsonContents.styles[0][OpenSkin_jsonAppName]) {
      ...
      // iGBA methods are officially in the OpenSkin spec.
      element += "#emulatorPopup {" + sanLite(OpenSkin_jsonContents.styles[0][OpenSkin_jsonAppName][0].emulatorPopup) + ";" + "}";
