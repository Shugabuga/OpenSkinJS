// OpenSkinJS v2.1.7 (c) HeyItsShuga. Licensed under MIT.
...
function OpenSkin() {
  ...
  this.load = function() {
    ...
    element += ".md .navbar-inner, .statusbar, .md {" + sanLite(OpenSkin_jsonContents.styles[0].mdHeader) + ";" + "}";
    ...
    element += ".tint, .back > span, .back > div, .ios .searchbar-disable-button, .ios .color-theme-red .searchbar-disable-button {" + sanLite(OpenSkin_jsonContents.styles[0].tint) + ";" + "}";
    ...
    element += ".item-content, .inset>ul>div>div>a>.card, .swiper-slide, .list, .inset, .block-strong, .inset>ul, .list.inset>ul>div.row, .ios .list ul, .div.block.inset {" + sanLite(OpenSkin_jsonContents.styles[0].cell) + "}";
    ...
    if(OpenSkin_jsonContents.styles[0][OpenSkin_jsonAppName]) {
      ...
      element += ".md .navbar-inner, .statusbar, .md {" + sanLite(OpenSkin_jsonContents.styles[0][OpenSkin_jsonAppName][0].mdHeader) + ";" + "}";
      ...
      element += ".tint, .back > span, .back > div, .ios .searchbar-disable-button, .ios .color-theme-red .searchbar-disable-button {" + sanLite(OpenSkin_jsonContents.styles[0][OpenSkin_jsonAppName][0].tint) + ";" + "}";
      try { // Back arrow: create svg to go with given color value. Potentially unstable.
      ...
      element += ".item-content, .inset>ul>div>div>a>.card, .swiper-slide, .list, .inset, .block-strong, .inset>ul, .list.inset>ul>div.row, .ios .list ul, .div.block.inset {" + sanLite(OpenSkin_jsonContents.styles[0][OpenSkin_jsonAppName][0].cell) + "}";
